...
make_figure_A1 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1) {
  if(reload) {
    summary <- load_data(1)
  }
  
  df <- summary %>%
    filter(plot=="Klab", epsilon==plot.epsilon, model_name=="B", K %in% label.values) %>%
...
make_figure_A1(plot.epsilon=0.1, save_plots=TRUE, reload=FALSE)

#' Plot 2: Finite sample correction as a function of the number of classes, for different
#'         values of the calibration set size
make_figure_A2 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1) {
  if(reload) {
    summary <- load_data(1)
  }
  
  df <- summary %>%
    filter(plot=="nlab", epsilon==plot.epsilon, model_name=="B", n_cal %in% label.values) %>%
    mutate(Method = factor(Method, levels = method.values, labels = method.labels)) %>%
...
make_figure_A2(plot.epsilon=0.1, save_plots=TRUE, reload=FALSE)
...
#' Plot 1: Finite sample correction as a function of the calibration set size,
#'         for different number of classes
make_figure_A1 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1, plot.nu=0.2) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A1(plot.epsilon=0.1, plot.nu=0.2, save_plots=TRUE, reload=FALSE)

#' Plot 2: Finite sample correction as a function of the number of classes, for different
#'         values of the calibration set size
make_figure_A2 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1, plot.nu=0.2) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A2(plot.epsilon=0.1, plot.nu=0.2, save_plots=TRUE, reload=FALSE)
...
make_figure_A3 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon.vals=c(0.1, 0.5), plot.nu=0.2) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A3(plot.epsilon.vals=c(0.1,0.5), plot.nu=0.2, save_plots=TRUE, reload=FALSE)
...
#'         
make_figure_A4 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon.vals=c(0.1,0.5), plot.nu=0.2) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A4(plot.epsilon.vals=c(0.1,0.5), plot.nu=0.2, save_plots=TRUE, reload=FALSE)
...
#' Plot 7: Finite sample correction as a function of the calibration set size,
#'         for different number of classes
make_figure_A7 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1, plot.nu=0.2) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A7(plot.epsilon=0.1, plot.nu="none", save_plots=TRUE, reload=FALSE)

#' Plot 8: Finite sample correction as a function of the number of classes, for different
#'         values of the calibration set size
make_figure_A8 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1, plot.nu=0.2) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A8(plot.epsilon=0.1, plot.nu="none", save_plots=TRUE, reload=FALSE)
...
make_figure_A9(plot.epsilon=0.1, plot.nu=0.2, save_plots=TRUE, reload=FALSE)
...
make_figure_A10(plot.epsilon=0.1, plot.nu=0.2, save_plots=TRUE, reload=FALSE)

#' Plot 11: Finite sample correction as a function of the calibration set size,
#'         for different number of classes and for different combinations of epsilon and nu
#'

make_figure_A11 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1, plot.nu.vals=c(0.2,0.8)) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A11(plot.epsilon=0.1, plot.nu.vals=c(0.2,0.8), save_plots=TRUE, reload=FALSE)
...
#'         values of the calibration set size and for different combinations of epsilon and nu
#'         
make_figure_A12 <- function(save_plots=FALSE, reload=FALSE, plot.epsilon=0.1, plot.nu.vals=c(0.2,0.8)) {
  if(reload) {
    summary <- load_data(1)
  }
...
make_figure_A12(plot.epsilon=0.1, plot.nu.vals=c(0.2, 0.8), save_plots=TRUE, reload=FALSE)
