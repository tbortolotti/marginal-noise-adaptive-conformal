...
def simulate_gaussian_process(cov_function, grid, num_samples, n_cal, scores, W, F_hat, joint_F_hat_vals):
...
def simulate_supremum(cov_function, h, num_samples, grid_type, n_cal, scores, W, F_hat):
